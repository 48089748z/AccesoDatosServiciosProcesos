...
import java.io.File;
public class ModeAdministratiuOriol
{
    private static final String adminUsername = "admin";
    private static final String adminPassword = "dionis";
    private static final String filePath = "/home/48089748z/Escriptori/IdeaProjects/DadesIServeis/src/UF3AAD/ExamenUF3/mondial.xml";
    private static final String mainCollection ="/db";
    private static final String myCollection ="/oriolCunado";
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            queryResource("collection('oriolCunado')/mondial/country/name");
        }
        ...
        private static void createCollection() throws XMLDBException, ClassNotFoundException, IllegalAccessException, InstantiationException
        {
            ...
            c.createCollection("oriolCunado");
        }
    ...
    private static void queryResource(String query) throws XQException
    {
        //CONEXIÓN
        ...
        String[] results = resultados.replaceAll("</name>","").split("<name>");
