...
/**
 * <p>Java class for PLANETSType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="PLANET" type="{}PLANETType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PLANETSType", propOrder = {
    "planet"
})
...
public class PLANETSType {
    ...
    protected List<PLANETType> planet;
     ...
     * 
     */
    public List<PLANETType> getPLANET() {
        if (planet == null) {
            planet = new ArrayList<PLANETType>();
        }
        return this.planet;
    }
